                                ...
                                <div class="row">
                                    <div class="col-md-8 mx-auto">
                                        ...
                                        <div class="form-group {{ $errors->has('bank_swift_code')? 'has-error':'' }}">
                                            <label for="bank_swift_code" class="col-4 control-label">
                                        ...
                                        <div class="form-group {{ $errors->has('account_number')? 'has-error':'' }}">
                                            <label for="account_number" class="col-4 control-label">@lang('app.account_number') <span class="field-required">*</span></label>
                                            <div class="col-8">
                                        ...
                                        <div class="form-group {{ $errors->has('branch_name')? 'has-error':'' }}">
                                            <label for="branch_name" class="col-4 control-label">@lang('app.branch_name') <span class="field-required">*</span></label>
                                            <div class="col-8">
                                        ...
                                        <div class="form-group {{ $errors->has('branch_address')? 'has-error':'' }}">
                                            <label for="branch_address" class="col-4 control-label">@lang('app.branch_address') <span class="field-required">*</span></label>
                                            <div class="col-8">
                                        ...
                                        <div class="form-group {{ $errors->has('account_name')? 'has-error':'' }}">
                                            <label for="account_name" class="col-4 control-label">@lang('app.account_name') <span class="field-required">*</span></label>
                                            <div class="col-8">
                                        ...
                                        <div class="form-group {{ $errors->has('iban')? 'has-error':'' }}">
                                            <label for="iban" class="col-4 control-label">@lang('app.iban')</label>
                                            <div class="col-8">
