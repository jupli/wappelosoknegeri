...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="{{ route('admin_comments') }}"><i class="fa fa-comment-o"></i> @lang('app.comments') </a>  </li>
        ...
        @if($auth_user->is_admin())
                ...
                <li> <a href="{{route('requested_account_deletion')}}"><i class="fa fa-trash-o"></i> @lang('app.requested_account_deletion')</a>  </li>
            @endif
