                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="form-group row {{ $errors->has('description')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="description" class="form-control description" id="description" rows="15">{{ $campaign->description}}</textarea>
                            ...
                            <div class="form-group row {{ $errors->has('feature_image')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    {!! image_upload_form('feature_image', $campaign->feature_image) !!}
                                </div>
                            </div>
