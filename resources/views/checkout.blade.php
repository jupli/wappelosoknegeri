            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-7">
                            ...
                            <div class="form-group row {!! $errors->has('contributor_name_display')? 'has-error':'' !!}">
                                <div class="col-12">
                        ...
                        <div class="donation-summery">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="submit" class="btn-block btn hu-btn-filled btn-lg">@lang('app.submit_payment')</button>
