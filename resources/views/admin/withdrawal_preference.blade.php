                ...
                <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row {{ $errors->has('default_withdrawal_account')? 'has-error':'' }}">
                            ...
                            <div class="config_wrap paypal-wrap" style="display: @if(withdrawal_preference() == 'paypal') block @else none @endif;">
                                ...
                                <div class="form-group row {{ $errors->has('paypal_email')? 'has-error':'' }}">
                            ...
                            <div class="config_wrap bank-wrap" style="display: @if(withdrawal_preference() == 'bank') block @else none @endif;" >
                                ...
                                <div class="form-group row {{ $errors->has('bank_account_holders_name')? 'has-error':'' }}">
                                ...
                                <div class="form-group row {{ $errors->has('bank_account_number')? 'has-error':'' }}">
                                ...
                                <div class="form-group row {{ $errors->has('swift_code')? 'has-error':'' }}">
                                ...
                                <div class="form-group row {{ $errors->has('bank_name_full')? 'has-error':'' }}">
                                ...
                                <div class="form-group row {{ $errors->has('bank_branch_name')? 'has-error':'' }}">
                                ...
                                <div class="form-group row {{ $errors->has('bank_branch_city')? 'has-error':'' }}">
                                ...
                                <div class="form-group row {{ $errors->has('bank_branch_address')? 'has-error':'' }}">
                                ...
                                <div class="form-group row {{ $errors->has('country_id')? 'has-error':'' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="country_id" name="country_id" class="form-control select2">
                                            ...
                                            @php
                                            $withdrawal_country_id = withdrawal_preference('country_id');

                                            @endphp

                                            <option value="">@lang('app.select_a_country')</option>
                                            @foreach($countries as $country)
                                                <option value="{{ $country->id }}" {{ $withdrawal_country_id == $country->id ? 'selected' :'' }}>{{ $country->name }}</option>
                                            @endforeach
                                        </select>
