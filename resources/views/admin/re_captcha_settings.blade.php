            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    ...
                    <div id="social_login_settings_wrap">
                        ...
                        <div class="form-group row {{ $errors->has('enable_recaptcha_login')? 'has-error':'' }}">
                        ...
                        <div class="form-group row {{ $errors->has('enable_recaptcha_registration')? 'has-error':'' }}">
                            <label class="col-md-4 control-label">@lang('app.enable_disable') </label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row {{ $errors->has('enable_recaptcha_contact_form')? 'has-error':'' }}">
                            <label class="col-md-4 control-label">@lang('app.enable_disable') </label>
                            <div class="col-md-8">
