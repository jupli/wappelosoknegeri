            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    ...
                    <div id="social_login_settings_wrap">
                        ...
                        <div class="form-group row {{ $errors->has('enable_social_login')? 'has-error':'' }}">
                        ...
                        <div class="form-group row {{ $errors->has('enable_facebook_login')? 'has-error':'' }}">
                            <label class="col-md-4 control-label">@lang('app.enable_disable') </label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row {{ $errors->has('enable_google_login')? 'has-error':'' }}">
                            <label class="col-md-4 control-label">@lang('app.enable_disable') </label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row {{ $errors->has('enable_twitter_login')? 'has-error':'' }}">
                            <label class="col-md-4 control-label">@lang('app.enable_disable') </label>
                            <div class="col-md-8">
