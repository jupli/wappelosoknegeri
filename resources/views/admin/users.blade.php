                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{!!route('users_view', $user->id)!!}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> </a>
                                            ...
                                            @if($user->active_status == 0)
                                                ...
                                                <a href="{!!route('user_delete', $user->id)!!}" class="btn btn-danger btn-sm" data-toggle="tooltip" title="@lang('app.delete')"><i class="fa fa-trash-o"></i> </a>
