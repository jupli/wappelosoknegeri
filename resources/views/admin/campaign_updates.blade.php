        ...
        <div class="container">
            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-8 col-offset-1 col-xs-12">

                            {{ Form::open(['class' => 'form-horizontal', 'files' => true]) }}


                            <div class="form-group row {{ $errors->has('title')? 'has-error':'' }}">
                                <label for="title" class="col-4 control-label">@lang('app.title')</label>
                                <div class="col-8">
                            ...
                            <div class="form-group row {{ $errors->has('description')? 'has-error':'' }}">
                                <label for="description" class="col-4 control-label">@lang('app.description')</label>
                                <div class="col-8">
                            ...
                            <div class="col-xs-12">
                                <table class="table table-bordered categories-lists">
                                    ...
                                    @foreach($updates as $update)
                                        <tr>
                                            <td> {{ $update->title }}  </td>
                                            <td> <img src="{!! media_image_uri($update->image_id)->thumbnail !!}" />  </td>
